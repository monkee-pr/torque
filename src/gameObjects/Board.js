class Board extends GameObject {
    constructor(gp) {
        ...
        const fields = [
            ...
            new Field(gp, new Hex(-8, 0), Field.TYPE_PIT),
            new Field(gp, new Hex(-8, 1), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_BACK),
            new Field(gp, new Hex(-8, 2)),
            new Field(gp, new Hex(-8, 3)),
            new Field(gp, new Hex(-8, 4)),
            ...
            new Field(gp, new Hex(-7, -3), Field.TYPE_HOLE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(-7, -2)),
            new Field(gp, new Hex(-7, -1)),
            new Field(gp, new Hex(-7, 0), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_BACK),
            new Field(gp, new Hex(-7, 1)),
            new Field(gp, new Hex(-7, 2)),
            new Field(gp, new Hex(-7, 3), Field.TYPE_HOLE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-7, 4)),
            new Field(gp, new Hex(-7, 5)),
            new Field(gp, new Hex(-6, -5)),
            new Field(gp, new Hex(-6, -4)),
            new Field(gp, new Hex(-6, -3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            ...
            new Field(gp, new Hex(-6, 1)),
            new Field(gp, new Hex(-6, 2)),
            new Field(gp, new Hex(-6, 3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-6, 4)),
            new Field(gp, new Hex(-6, 5)),
            new Field(gp, new Hex(-5, -5)),
            new Field(gp, new Hex(-5, -4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(-5, -3), Field.TYPE_PIT),
            new Field(gp, new Hex(-5, -2), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(-5, -1)),
            new Field(gp, new Hex(-5, 0)),
            new Field(gp, new Hex(-5, 1)),
            new Field(gp, new Hex(-5, 2), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-5, 3), Field.TYPE_PIT),
            new Field(gp, new Hex(-5, 4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-5, 5)),
            new Field(gp, new Hex(-4, -5)),
            new Field(gp, new Hex(-4, -4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            ...
            new Field(gp, new Hex(-4, 1)),
            new Field(gp, new Hex(-4, 2), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-4, 3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-4, 4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-4, 5)),
            new Field(gp, new Hex(-3, -5)),
            new Field(gp, new Hex(-3, -4)),
            new Field(gp, new Hex(-3, -3), Field.TYPE_SUPER_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(-3, -2)),
            new Field(gp, new Hex(-3, -1)),
            new Field(gp, new Hex(-3, 0)),
            new Field(gp, new Hex(-3, 1)),
            new Field(gp, new Hex(-3, 2)),
            new Field(gp, new Hex(-3, 3), Field.TYPE_SUPER_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(-3, 4)),
            new Field(gp, new Hex(-3, 5)),
            new Field(gp, new Hex(-2, -5)),
            new Field(gp, new Hex(-2, -4)),
            new Field(gp, new Hex(-2, -3)),
            ...
            new Field(gp, new Hex(-2, 4)),
            new Field(gp, new Hex(-2, 5)),
            new Field(gp, new Hex(-1, -5), Field.TYPE_MIDFIELD),
            ...
            new Field(gp, new Hex(-1, 4)),
            new Field(gp, new Hex(-1, 5), Field.TYPE_MIDFIELD),
            new Field(gp, new Hex(0, -5), Field.TYPE_MIDFIELD),
            new Field(gp, new Hex(0, -4), Field.TYPE_MIDFIELD),
            new Field(gp, new Hex(0, -3), Field.TYPE_MIDFIELD),
            new Field(gp, new Hex(0, -2), Field.TYPE_MIDFIELD),
            ...
            new Field(gp, new Hex(2, -5)),
            new Field(gp, new Hex(2, -4)),
            new Field(gp, new Hex(2, -3), Field.TYPE_SUPER_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(2, -2)),
            new Field(gp, new Hex(2, -1)),
            new Field(gp, new Hex(2, 0)),
            new Field(gp, new Hex(2, 1)),
            new Field(gp, new Hex(2, 2)),
            new Field(gp, new Hex(2, 3), Field.TYPE_SUPER_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(2, 4)),
            new Field(gp, new Hex(2, 5)),
            new Field(gp, new Hex(3, -5)),
            new Field(gp, new Hex(3, -4)),
            new Field(gp, new Hex(3, -3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(3, -2)),
            new Field(gp, new Hex(3, -1)),
            new Field(gp, new Hex(3, 0)),
            new Field(gp, new Hex(3, 1)),
            new Field(gp, new Hex(3, 2)),
            new Field(gp, new Hex(3, 3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(3, 4)),
            new Field(gp, new Hex(3, 5)),
            new Field(gp, new Hex(4, -5)),
            new Field(gp, new Hex(4, -4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(4, -3), Field.TYPE_PIT),
            new Field(gp, new Hex(4, -2), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(4, -1)),
            new Field(gp, new Hex(4, 0)),
            new Field(gp, new Hex(4, 1)),
            ...
            new Field(gp, new Hex(5, 1)),
            new Field(gp, new Hex(5, 2), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(5, 3), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(5, 4), Field.TYPE_HOT_ZONE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(5, 5)),
            new Field(gp, new Hex(6, -5)),
            new Field(gp, new Hex(6, -4)),
            new Field(gp, new Hex(6, -3), Field.TYPE_HOLE, Field.STRIKE_AREA_LEFT),
            new Field(gp, new Hex(6, -2)),
            new Field(gp, new Hex(6, -1)),
            new Field(gp, new Hex(6, 0), Field.TYPE_SUPER_HOT_ZONE, Field.STRIKE_AREA_BACK),
            new Field(gp, new Hex(6, 1)),
            new Field(gp, new Hex(6, 2)),
            new Field(gp, new Hex(6, 3), Field.TYPE_HOLE, Field.STRIKE_AREA_RIGHT),
            new Field(gp, new Hex(6, 4)),
            new Field(gp, new Hex(6, 5)),
            new Field(gp, new Hex(7, -5)),
            new Field(gp, new Hex(7, -4)),
