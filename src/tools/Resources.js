...
function loadResources(doneFunc) {
    ...
    let imageQueue = [
        ...
        {name: "playerDartBlueHoldingLeft", src: "res/objects/c_b_dart_02.png"},
        {name: "playerDartBlueHoldingRight", src: "res/objects/c_b_dart_02_f.png"},
        ...
        {name: "playerMaulBlueHoldingLeft", src: "res/objects/c_b_maul_02.png"},
        {name: "playerMaulBlueHoldingRight", src: "res/objects/c_b_maul_02_f.png"},
        {name: "playerDartRedHoldingLeft", src: "res/objects/c_r_dart_02.png"},
        {name: "playerDartRedHoldingRight", src: "res/objects/c_r_dart_02_f.png"},
        {name: "playerBladeRedHoldingLeft", src: "res/objects/c_r_blade_02.png"},
        {name: "playerBladeRedHoldingRight", src: "res/objects/c_r_blade_02_f.png"},
        {name: "playerMaulRedHoldingLeft", src: "res/objects/c_r_maul_02.png"},
        {name: "playerMaulRedHoldingRight", src: "res/objects/c_r_maul_02_f.png"},
